...
class OrderHistory extends Model
{
    ...
    public function generateDescription(string $itemName = null, string $itemQty = null, string $printerIdentifier = null, string $paymentAmount = null, $POSNumber = null): string
    {
        $description = '';
        // dd(func_get_args());
        switch ($this->action_type) {
            ...
            case 'pdf-generated':
                $description = 'PDF Bill generated by ' . $this->user->getFullname();
                break;
