...
<body style="max-width: 320px;padding: 0.5px;">
            ...
            <table style=";;;;width:100%;">
                <tr>
                    <td style=";;;;text-align:left;width:10px;">
                        <img src="{{ public_path('images/logo_blk.jpg') }}"
                            style=";;;;border-radius:50%;width:1.5rem;height:1.5rem;display:block;" alt="Logo">
                    </td>
                    <td style=";;;;text-align:left;">
                        <div style=";;;;font-size:0.7rem;margin:0rem;font-weight:bold;overflow:hidden">
                            {{ config('app.companyName') }}
                        </div>
                        <div style=";;;;font-size:0.4rem;margin:0rem;text-align:left;">
    ...
    <footer>
        ...
        <p class="text-center" style=";;;;font-style: italic;color: grey">
