    ...
    <footer>
        ...
        @foreach ($order->items as $index => $item)
            ...
            <table class="tokentable" style=";;;;border-collapse: collapse; border-spacing: 0;">
                ...
                <tr>
                    <td style="font-size: 16px;font-weight: bold;">{{ $item->product->name }} -
                        {{ $item->product->description }}</td>
                    <td style=";;;;text-align:center">{{ number_format($item->product->price) }}
                    </td>
                    <td style=";;;;font-size: 16px;text-align:center;" class="text-center font-extrabold">
                        {{ $item->quantity }}
                    </td>
                    {{-- <td style=";;;;text-align:right">{{ number_format($item->price, 2) }}</td> --}}
                </tr>
