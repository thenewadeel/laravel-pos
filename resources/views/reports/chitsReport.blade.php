    ...
    <div class="card">
        <div class="card-header font-bold text-lg">
            <div class=" flex flex-row justify-between">
                QCL - Chit Bills Report
                <a href="{{ route('orders.printBulk', ['orderIdsArray' => json_encode($orders->pluck('id')->toArray())]) }}" class="btn btn-dark btn-sm border-2 border-green-800 text-black">{{ __('common.Download_Bulk_Chits') }}</a>
