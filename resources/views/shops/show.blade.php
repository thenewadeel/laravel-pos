    ...
    <div class="container ">
        ...
        <div class="max-w-6xl mx-auto font-[sans-serif] text-[#333]">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-12">
                <div class="p-4 text-center">
                    ...
                    <p class="text-gray-500 text-sm">Tailor our product to suit your needs Tailor our product to suit your
                        needs.</p>
                </div>
                <div class="p-4 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block"
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-gray-500 text-sm">Tailor our product to suit your needs 24/7 customer support for all
                        your inquiries.</p>
                </div>
                <div class="p-4 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block"
                ...
                <div class="p-4 text-center">
                    ...
                    <p class="text-gray-500 text-sm">Tailor our product to suit your needs Expand your reach with our global
                        network.</p>
                </div>
                <div class="p-4 text-center">
                    <svg xmlns="http://www.w3.org/2000/svg" fill="currentColor" class="w-8 mb-4 inline-block"
                    ...
                    <p class="text-gray-500 text-sm">Tailor our product to suit your needs Seamless communication for your
                        team.</p>
                </div>
            </div>
        </div>
        <div class="space-y-4">
            <div class="flex items-center justify-between">
                <div class="font-bold text-xl ">Shop ID: {{ $shop->id }}</div>
            </div>
            <div class="flex items-center justify-between">
                <div class="font-semibold text-lg">Shop Name: {{ $shop->name }}</div>
            </div>
            <div class="flex items-center justify-between">
                <div class="font-light text-base">Description: {{ $shop->description }}</div>
            </div>
            <div class="flex items-center justify-between">
                <div class="font-light text-base">Shop Image: <img width="50" src="{{ $shop->image }}"
                        alt="Shop Image"></div>
            </div>
            <div class="flex items-center justify-between">
                <div class="font-light text-base">Owner Details:
                    @if ($shop->user)
                        <ul class="list-inside">
                            <li>User ID: {{ $shop->user->id }}</li>
                            <li>User Email: {{ $shop->user->email }}</li>
                        </ul>
                    @else
                        <p class="text-gray-600">No associated user found.</p>
                    @endif
                </div>
            </div>
            <div class="flex items-center justify-between">
                <div class="font-light text-base">Created At: {{ $shop->created_at }}</div>
            </div>
        </div>
        ...
        <a href="{{ route('shops.edit', $shop) }}" class="btn btn-primary"><i class="fas fa-edit"></i></a>
        <a class="btn btn-danger btn-delete" href="{{ route('shops.destroy', $shop) }}"><i class="fas fa-trash"></i></a>
